...
console.log('%c Theme.Shoka v' + CONFIG.version + ' %c https://chengziyu.xyz/blog/', 'color: white; background: #e9546b; padding:5px 0;', 'padding:4px;border:1px solid #e9546b;')
